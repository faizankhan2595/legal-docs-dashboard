		...
		<> 
			<Row gutter={16}>
				<Col xs={24} sm={24} md={24} lg={24}>
					<Card title="Your Orders" extra={<Button type="primary" onClick={showModal}>Create New Order</Button>}>
						<NewOrder visible={visible} setVisible={changeVisible} getOrders={getOrders} />
						<Table 
